...
data_manager = DataManager(       # initialize data manager
    ...
    fs_root_folder="bmld-giuliana-ladina"  # folder on switch drive where the data is stored
    ) 
...
pg_second = st.Page("views/Kalorienbedarf-Rechner.py", title="Kalorienbedarf Rechner", icon=":material/info:")
